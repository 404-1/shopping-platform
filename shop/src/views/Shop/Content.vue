        ...
        <div class="product">
            <div class="product__item" v-for="item in contentList" :key="item._id">
                ...
                <div class="product__item__number">
                    <span class="product__item__number__minus" @click="() => {changeCartItem(shopId, item._id, item, -1, shopName)}">-</span>
                    {{cartList?.[shopId]?.productList?.[item._id]?.count || 0}}
                    <span class="product__item__number__plus" @click="() => {changeCartItem(shopId, item._id, item, 1, shopName)}">+</span>
                </div>
            </div>
        </div>
    </div>
...
export default {
  ...
  setup () {
    ...
    return { categories, contentList, currentTab, handleTabClick, changeCartItem, cartList, shopId }
  }
}
</script>
